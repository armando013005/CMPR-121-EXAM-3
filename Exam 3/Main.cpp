...
void displayMenu() {
    ...
    cout << setw(3) << string(1, char(192)) << string(8, char(196)) << string(1, char(193)) << string(6, char(196)) << string(1, char(193)) << string(8, char(196)) << string(1, char(217)) << setw(6) << string(1, char(192)) << string(9, char(196)) << string(1, char(188)) << " " << string(1, char(192)) << string(7, char(196)) << string(3, char(196)) << string(1, char(188)) << " " << string(1, char(192)) << string(7, char(196)) << string(1, char(196)) << string(1, char(196)) << string(1, char(196)) << string(1, char(188)) << setw(6) << string(1, char(186)) << " " << string(1, char(179)) << "  73 / 61 " << string(1, char(179)) << " " << string(1, char(186)) << setw(11) << " front " << string(1, char(186)) << " " << string(1, char(179)) << "- 71 / 72  " << string(1, char(179)) << " " << string(1, char(186)) << endl;
